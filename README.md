...
* **Intent-Driven Routing:** Every message first hits a **Classifier Node**. This ensures that "Greetings," "Pricing Inquiries," and "Sign-up Requests" are handled by specialized logic paths, preventing hallucinations.
